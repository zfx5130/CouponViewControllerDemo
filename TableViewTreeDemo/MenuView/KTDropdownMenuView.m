...
- (instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titles navigationTitle:(NSString *)navigationTitle {
...
- (void)registerCell {
    UINib *menuCell = [UINib nibWithNibName:NSStringFromClass([MenuTableViewCell class]) bundle:nil];
    [self.tableView registerNib:menuCell forCellReuseIdentifier:NSStringFromClass([MenuTableViewCell class])];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.menuTitleLabel.text = [self.titles objectAtIndex:indexPath.row];
    tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    cell.tintColor = self.cellAccessoryCheckmarkColor;
    cell.backgroundColor = self.cellColor;
    cell.menuTitleLabel.font = self.textFont;
    cell.menuTitleLabel.textColor = self.textColor;
...
- (UIButton *)titleButton
{
    if (!_titleButton)
    {
        ...
        [_titleButton setTitle:self.navigationTitle forState:UIControlStateNormal];
